# Generated by Django 3.0.5 on 2024-06-02 00:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Plumbing', 'Plumbing'), ('Electricity', 'Electricity'), ('Painting', 'Painting'), ('Carpentry', 'Carpentry')], max_length=50)),
                ('service_no', models.PositiveIntegerField()),
                ...
                ('Technician', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='service.Technician')),
